...
# png(snakemake@output[['dimred_cell_type']], width = 1600, height = 800)
...
lapply(celltypes, function(celltype) {
  # png(paste0(individual_dimred_plot_dir, dimred, "-celltype-assignment-score-", celltype, ".png"), width = 800, height = 800)
