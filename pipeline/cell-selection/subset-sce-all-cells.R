...
print(paste0("subsetting: the ", snakemake@wildcards[["cohort"]], " cohort, for ", cell_type, " cells, using ", celltype_label_field, " labels."))
...
# subset to cell_type cells
sce <- sce[,grepl(cell_type, colData(sce)[[celltype_label_field]])]
